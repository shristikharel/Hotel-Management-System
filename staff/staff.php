    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="staff.php?dashboard" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        class="fas fa-tachometer-alt me-2"></i>Dashboard</a>
                <a href="staff.php?insert_category" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="bi bi-house-add-fill me-2"></i>Insert Category</a>
                <a href="staff.php?insert_room" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="bi bi-house-add-fill me-2"></i>Insert Rooms</a>
                <a href="staff.php?view_room" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="bi bi-house-check-fill me-2"></i>View Rooms</a>
                <a href="staff.php?insert_facility" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="bi bi-house-gear-fill me-2"></i>View Facilities</a>
                <a href="staff.php?insert_feature" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="bi bi-house-heart-fill me-2"></i>View Features</a>
                <a href="staff.php?view_user" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="bi bi-people-fill me-2"></i>View Users</a>
                <a href="staff.php?view_bookings" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="bi bi-bookmark-check-fill me-2"></i>Bookings</a>
                <a href="staff.php?insert_stats" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
