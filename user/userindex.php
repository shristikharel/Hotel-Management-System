...
<div class="container">
    ...
    if ($rating_result && mysqli_num_rows($rating_result) > 0) {
        ...
        echo 'No ratings yet';
                ...
                echo '<a href="book.php" class="btn btn-sm btn-outline-dark shadow-none">Book Now</a>';
                echo '<span style="margin-right: 10px;"></span>';
                echo '<a href="#" class="btn btn-sm btn-outline-dark shadow-none">More Details</a>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
        ...
        <div class="swiper-wrapper mb-4">
            ...
            if ($facResult && mysqli_num_rows($facResult) > 0) {
                while ($row = mysqli_fetch_assoc($facResult)) {
                    ...
                    <img src="../uploads/facilities/<?php echo $image; ?>" class="w-100" alt="<?php echo $name; ?>">
    ...
    <div class="swiper-wrapper mb-5">
      <div class="swiper-slide bg-white p-4">
        <div class="profile d-flex align-items-center mb-3">
          <img src="images/facilities/3.svg" width="30px">
          <h6 class="m-0 ms-2">Random User 1</h6>
          </div>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Rerum quod laudantium quasi? </p>
