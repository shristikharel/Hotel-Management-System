        ...
        if (mysqli_num_rows($result_select) > 0) {
            ...
            while($row = mysqli_fetch_array($result_select)){
                ...
                $number++;
                    ...
                    <td>Rs.$room_price/-</td>
                    <td><a href='admin.php?edit_rooms=$room_id' class='text-dark'><i class='fas fa-edit text-dark'></i></a></td>
                    <td><a href='admin.php?delete_rooms=$room_id' class='text-dark'><i class='fas fa-trash'></i></a></td>
