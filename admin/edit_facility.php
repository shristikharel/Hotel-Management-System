...
if (isset($_GET['edit_facility'])) {
    ...
    $select_query = "SELECT * FROM `facilities` WHERE `facility_id` = '$facility_id' AND `user_id` = '" . get_user_id_admin() . "'";
...
<form action="" method="post" class="mb-2" enctype="multipart/form-data">
    ...
    <div class="input-group w-90 mb-2">
        <img src="<?php echo $facility_image; ?>" alt="Facility Image" class="img">
